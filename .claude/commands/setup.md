...
Then proceed to Step 3 to populate the non-skill files (`CLAUDE.md`, `cv/main_example.tex`, `.claude/skills/search-and-rank/search-queries.md`). Step 3 will detect that the seven skill files are already populated and skip those substeps.
...
### 8. Generate `.claude/skills/search-and-rank/search-queries.md`
...
> - `.claude/skills/search-and-rank/search-queries.md` - Job search queries for `/scrape`
>
